...
if [[ "$arch" == "$rule_arch" ]] || [[ -z "$rule_arch" ]]; then
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_687a63d69bb9ee130a3e2693.audit').objectForKey('os_efi_integrity_validated'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_687a63d69bb9ee130a3e2693.audit').objectForKey('os_efi_integrity_validated'))["exempt_reason"]
EOS
)
    ...
    if [[ $result_value == "1" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_efi_integrity_validated passed (Result: $result_value, Expected: "{'integer': 1}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_efi_integrity_validated failed (Result: $result_value, Expected: "{'integer': 1}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_efi_integrity_validated failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
EOS
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_687a63d69bb9ee130a3e2693.audit').objectForKey('os_firewall_log_enable'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_687a63d69bb9ee130a3e2693.audit').objectForKey('os_firewall_log_enable'))["exempt_reason"]
EOS
)
    ...
    if [[ $result_value == "true" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_firewall_log_enable passed (Result: $result_value, Expected: "{'string': 'true'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_firewall_log_enable failed (Result: $result_value, Expected: "{'string': 'true'}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_firewall_log_enable failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_gatekeeper_enable passed (Result: $result_value, Expected: "{'integer': 1}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_gatekeeper_enable failed (Result: $result_value, Expected: "{'integer': 1}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_gatekeeper_enable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_nfsd_disable passed (Result: $result_value, Expected: "{'integer': 1}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_nfsd_disable failed (Result: $result_value, Expected: "{'integer': 1}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - os_nfsd_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
if [[ "$arch" == "$rule_arch" ]] || [[ -z "$rule_arch" ]]; then
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_687a63d69bb9ee130a3e2693.audit').objectForKey('system_settings_cd_dvd_sharing_disable'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('com.jamf.compliance_benchmark_687a63d69bb9ee130a3e2693.audit').objectForKey('system_settings_cd_dvd_sharing_disable'))["exempt_reason"]
EOS
)
    ...
    if [[ $result_value == "1" ]]; then
        ...
        /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - system_settings_cd_dvd_sharing_disable passed (Result: $result_value, Expected: "{'integer': 1}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - system_settings_cd_dvd_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}")"
        else
            ...
            /usr/bin/logger "mSCP: compliance_benchmark_687a63d69bb9ee130a3e2693 - system_settings_cd_dvd_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi

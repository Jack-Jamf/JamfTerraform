            ...
            policyJSON='
            {
                "steps": [
                    ...
                    },
                    {
                        ...
                        "progresstext": "Hold tight while we install your browsers",
                        "trigger_list": [
                            {
                                "trigger": "browsers",
                                "validation": "local"
                    ...
                    {
                        "listitem": "Microsoft Office 365 Applications",
                        "icon": "c05d087189f0b25a94f02eeb43b0c5c928e5e378f2168f603554bce2b5c71209",
                        "progresstext": "Taking care of your office apps",
                        "trigger_list": [
                            {
                    ...
                    {
                        "listitem": "Privilges App",
                        "icon": "ea794c5a1850e735179c7c60919e3b51ed3ed2b301fe3f0f27ad5ebd394a2e4b",
                        "progresstext": "This app will allow you to approve ScreenSharing for Slack, Zoom and other applications that might need camera and microphone access",
                        "trigger_list": [
                            {
                                "trigger": "privileges",
                                "validation": "local"
                    ...
                    },
                    {
                        ...
                        "progresstext": "Slack Slack Slack",
                        "trigger_list": [
                            {
                                "trigger": "slack",
                                "validation": "local"

...
EOS
    ...
    if [[ $result_value == "false" ]]; then
        echo "$(date -u) sysprefs_airplay_receiver_disable passed (Result: $result_value, Expected: "{'string': 'false'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_airplay_receiver_disable failed (Result: $result_value, Expected: "{'string': 'false'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_airplay_receiver_disable failed (Result: $result_value, Expected: "{'string': 'false'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_airplay_receiver_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_automatic_login_disable passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_automatic_login_disable failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_automatic_login_disable failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_automatic_login_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "18" ]]; then
        echo "$(date -u) sysprefs_bluetooth_menu_enable passed (Result: $result_value, Expected: "{'integer': 18}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_bluetooth_menu_enable failed (Result: $result_value, Expected: "{'integer': 18}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_bluetooth_menu_enable failed (Result: $result_value, Expected: "{'integer': 18}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_bluetooth_menu_enable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_bluetooth_menu_enable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_bluetooth_menu_enable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "0" ]]; then
        echo "$(date -u) sysprefs_bluetooth_sharing_disable passed (Result: $result_value, Expected: "{'boolean': 0}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_bluetooth_sharing_disable failed (Result: $result_value, Expected: "{'boolean': 0}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_bluetooth_sharing_disable failed (Result: $result_value, Expected: "{'boolean': 0}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_bluetooth_sharing_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_cd_dvd_sharing_disable passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_cd_dvd_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_cd_dvd_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_cd_dvd_sharing_disable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_cd_dvd_sharing_disable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_cd_dvd_sharing_disable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_critical_update_install_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_critical_update_install_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_critical_update_install_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_critical_update_install_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_filevault_enforce passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_filevault_enforce failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_filevault_enforce failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_filevault_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_firewall_enable passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_firewall_enable failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_firewall_enable failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_firewall_enable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_firewall_stealth_mode_enable passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_firewall_stealth_mode_enable failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_firewall_stealth_mode_enable failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_firewall_stealth_mode_enable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "0" ]]; then
        echo "$(date -u) sysprefs_guest_access_smb_disable passed (Result: $result_value, Expected: "{'boolean': 0}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_guest_access_smb_disable failed (Result: $result_value, Expected: "{'boolean': 0}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_guest_access_smb_disable failed (Result: $result_value, Expected: "{'boolean': 0}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_guest_access_smb_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_guest_account_disable passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_guest_account_disable failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_guest_account_disable failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_guest_account_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_install_macos_updates_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_install_macos_updates_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_install_macos_updates_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_install_macos_updates_enforce -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_install_macos_updates_enforce does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_install_macos_updates_enforce -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_internet_sharing_disable passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_internet_sharing_disable failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_internet_sharing_disable failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_internet_sharing_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "Center for Internet Security Test Message" ]]; then
        echo "$(date -u) sysprefs_loginwindow_loginwindowtext_enable passed (Result: $result_value, Expected: "{'string': 'center for internet security test message'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_loginwindow_loginwindowtext_enable failed (Result: $result_value, Expected: "{'string': 'center for internet security test message'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_loginwindow_loginwindowtext_enable failed (Result: $result_value, Expected: "{'string': 'center for internet security test message'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_loginwindow_loginwindowtext_enable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_loginwindow_loginwindowtext_enable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_loginwindow_loginwindowtext_enable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_loginwindow_prompt_username_password_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_loginwindow_prompt_username_password_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_loginwindow_prompt_username_password_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_loginwindow_prompt_username_password_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "0" ]]; then
        echo "$(date -u) sysprefs_password_hints_disable passed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_password_hints_disable failed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_password_hints_disable failed (Result: $result_value, Expected: "{'integer': 0}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_password_hints_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "false" ]]; then
        echo "$(date -u) sysprefs_personalized_advertising_disable passed (Result: $result_value, Expected: "{'string': 'false'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_personalized_advertising_disable failed (Result: $result_value, Expected: "{'string': 'false'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_personalized_advertising_disable failed (Result: $result_value, Expected: "{'string': 'false'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_personalized_advertising_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "0" ]]; then
        echo "$(date -u) sysprefs_power_nap_disable passed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_power_nap_disable failed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_power_nap_disable failed (Result: $result_value, Expected: "{'integer': 0}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_power_nap_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_printer_sharing_disable passed (Result: $result_value, Expected: "{'boolean': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_printer_sharing_disable failed (Result: $result_value, Expected: "{'boolean': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_printer_sharing_disable failed (Result: $result_value, Expected: "{'boolean': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_printer_sharing_disable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_printer_sharing_disable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_printer_sharing_disable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_rae_disable passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_rae_disable failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_rae_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_rae_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_remote_management_disable passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_remote_management_disable failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_remote_management_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_remote_management_disable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_remote_management_disable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_remote_management_disable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_screen_sharing_disable passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_screen_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_screen_sharing_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_screen_sharing_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_screensaver_ask_for_password_delay_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_screensaver_ask_for_password_delay_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_screensaver_ask_for_password_delay_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_screensaver_ask_for_password_delay_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_screensaver_password_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_screensaver_password_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_screensaver_password_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_screensaver_password_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_screensaver_timeout_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_screensaver_timeout_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_screensaver_timeout_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_screensaver_timeout_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_smbd_disable passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_smbd_disable failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_smbd_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_smbd_disable -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_software_update_app_update_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_software_update_app_update_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_software_update_app_update_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_software_update_app_update_enforce -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_software_update_app_update_enforce does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_software_update_app_update_enforce -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_software_update_download_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_software_update_download_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_software_update_download_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_software_update_download_enforce -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_software_update_download_enforce does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_software_update_download_enforce -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_software_update_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_software_update_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_software_update_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_software_update_enforce -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_software_update_enforce does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_software_update_enforce -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_softwareupdate_current passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_softwareupdate_current failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_softwareupdate_current failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_softwareupdate_current -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_softwareupdate_current does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_softwareupdate_current -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_ssh_disable passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_ssh_disable failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_ssh_disable failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_ssh_disable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_ssh_disable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_ssh_disable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "1" ]]; then
        echo "$(date -u) sysprefs_system_wide_preferences_configure passed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_system_wide_preferences_configure failed (Result: $result_value, Expected: "{'integer': 1}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_system_wide_preferences_configure failed (Result: $result_value, Expected: "{'integer': 1}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_system_wide_preferences_configure -dict-add finding -bool YES
...
echo "$error_count"
    ...
    exempt=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('org.cis_lvl1.audit').objectForKey('sysprefs_time_machine_encrypted_configure'))["exempt"]
EOS
)
    exempt_reason=$(/usr/bin/osascript -l JavaScript << EOS 2>/dev/null
ObjC.unwrap($.NSUserDefaults.alloc.initWithSuiteName('org.cis_lvl1.audit').objectForKey('sysprefs_time_machine_encrypted_configure'))["exempt_reason"]
EOS
)

    if [[ $result_value == "0" ]]; then
        echo "$(date -u) sysprefs_time_machine_encrypted_configure passed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
        /usr/bin/defaults write "$audit_plist" sysprefs_time_machine_encrypted_configure -dict-add finding -bool NO
        /usr/bin/logger "mSCP: cis_lvl1 - sysprefs_time_machine_encrypted_configure passed (Result: $result_value, Expected: "{'integer': 0}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_time_machine_encrypted_configure failed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_time_machine_encrypted_configure -dict-add finding -bool YES
            /usr/bin/logger "mSCP: cis_lvl1 - sysprefs_time_machine_encrypted_configure failed (Result: $result_value, Expected: "{'integer': 0}")"
        else
            echo "$(date -u) sysprefs_time_machine_encrypted_configure failed (Result: $result_value, Expected: "{'integer': 0}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_time_machine_encrypted_configure -dict-add finding -bool YES
            /usr/bin/logger "mSCP: cis_lvl1 - sysprefs_time_machine_encrypted_configure failed (Result: $result_value, Expected: "{'integer': 0}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
    ...
    echo "$(date -u) sysprefs_time_machine_encrypted_configure does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_time_machine_encrypted_configure -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "time.apple.com" ]]; then
        echo "$(date -u) sysprefs_time_server_configure passed (Result: $result_value, Expected: "{'string': 'time.apple.com'}")" | /usr/bin/tee -a "$audit_log"
        /usr/bin/defaults write "$audit_plist" sysprefs_time_server_configure -dict-add finding -bool NO
        /usr/bin/logger "mSCP: cis_lvl1 - sysprefs_time_server_configure passed (Result: $result_value, Expected: "{'string': 'time.apple.com'}")"
    else
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_time_server_configure failed (Result: $result_value, Expected: "{'string': 'time.apple.com'}")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_time_server_configure -dict-add finding -bool YES
            /usr/bin/logger "mSCP: cis_lvl1 - sysprefs_time_server_configure failed (Result: $result_value, Expected: "{'string': 'time.apple.com'}")"
        else
            echo "$(date -u) sysprefs_time_server_configure failed (Result: $result_value, Expected: "{'string': 'time.apple.com'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_time_server_configure -dict-add finding -bool YES
            /usr/bin/logger "mSCP: cis_lvl1 - sysprefs_time_server_configure failed (Result: $result_value, Expected: "{'string': 'time.apple.com'}") - Exemption Allowed (Reason: "$exempt_reason")"
            /bin/sleep 1
        fi
    fi
...
EOS
    ...
    if [[ $result_value == "true" ]]; then
        echo "$(date -u) sysprefs_time_server_enforce passed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_time_server_enforce failed (Result: $result_value, Expected: "{'string': 'true'}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_time_server_enforce failed (Result: $result_value, Expected: "{'string': 'true'}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_time_server_enforce -dict-add finding -bool YES
...
EOS
    ...
    if [[ $result_value == "0" ]]; then
        echo "$(date -u) sysprefs_wake_network_access_disable passed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_wake_network_access_disable failed (Result: $result_value, Expected: "{'integer': 0}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_wake_network_access_disable failed (Result: $result_value, Expected: "{'integer': 0}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_wake_network_access_disable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_wake_network_access_disable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_wake_network_access_disable -dict-add finding -bool NO
fi
...
EOS
    ...
    if [[ $result_value == "18" ]]; then
        echo "$(date -u) sysprefs_wifi_menu_enable passed (Result: $result_value, Expected: "{'integer': 18}")" | /usr/bin/tee -a "$audit_log"
        ...
        if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
            echo "$(date -u) sysprefs_wifi_menu_enable failed (Result: $result_value, Expected: "{'integer': 18}")" | /usr/bin/tee -a "$audit_log"
            ...
            echo "$(date -u) sysprefs_wifi_menu_enable failed (Result: $result_value, Expected: "{'integer': 18}") - Exemption Allowed (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
            /usr/bin/defaults write "$audit_plist" sysprefs_wifi_menu_enable -dict-add finding -bool YES
    ...
    echo "$(date -u) sysprefs_wifi_menu_enable does not apply to this architechture" | tee -a "$audit_log"
    /usr/bin/defaults write "$audit_plist" sysprefs_wifi_menu_enable -dict-add finding -bool NO
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_bluetooth_sharing_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_bluetooth_sharing_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/bin/sudo -u "$CURRENT_USER" /usr/bin/defaults -currentHost write com.apple.Bluetooth PrefKeyServicesEnabled -bool false
        fi
    else
        echo "$(date -u) Settings for: sysprefs_bluetooth_sharing_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_bluetooth_sharing_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_cd_dvd_sharing_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_cd_dvd_sharing_disable ..." | /usr/bin/tee -a "$audit_log"
            /bin/launchctl unload /System/Library/LaunchDaemons/com.apple.ODSAgent.plist
        fi
    else
        echo "$(date -u) Settings for: sysprefs_cd_dvd_sharing_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_cd_dvd_sharing_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_guest_access_smb_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_guest_access_smb_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/sbin/sysadminctl -smbGuestAccess off
        fi
    else
        echo "$(date -u) Settings for: sysprefs_guest_access_smb_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_guest_access_smb_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_power_nap_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_power_nap_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/bin/pmset -a powernap 0
        fi
    else
        echo "$(date -u) Settings for: sysprefs_power_nap_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_power_nap_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
/usr/bin/lpstat -p | awk '"'"'{print $2}'"'"'| /usr/bin/xargs -I{} lpadmin -p {} -o printer-is-shared=false ' N
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_printer_sharing_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/sbin/cupsctl --no-share-printers
/usr/bin/lpstat -p | awk '{print $2}'| /usr/bin/xargs -I{} lpadmin -p {} -o printer-is-shared=false
        fi
    else
        echo "$(date -u) Settings for: sysprefs_printer_sharing_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_printer_sharing_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
/bin/launchctl disable system/com.apple.AEServer ' N
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_rae_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/sbin/systemsetup -setremoteappleevents off
/bin/launchctl disable system/com.apple.AEServer
        fi
    else
        echo "$(date -u) Settings for: sysprefs_rae_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_rae_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_remote_management_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_remote_management_disable ..." | /usr/bin/tee -a "$audit_log"
            /System/Library/CoreServices/RemoteManagement/ARDAgent.app/Contents/Resources/kickstart -deactivate -stop
        fi
    else
        echo "$(date -u) Settings for: sysprefs_remote_management_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_remote_management_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_screen_sharing_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_screen_sharing_disable ..." | /usr/bin/tee -a "$audit_log"
            /bin/launchctl disable system/com.apple.screensharing
        fi
    else
        echo "$(date -u) Settings for: sysprefs_screen_sharing_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_screen_sharing_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_smbd_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_smbd_disable ..." | /usr/bin/tee -a "$audit_log"
            /bin/launchctl disable system/com.apple.smbd
        fi
    else
        echo "$(date -u) Settings for: sysprefs_smbd_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_smbd_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_softwareupdate_current_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_softwareupdate_current ..." | /usr/bin/tee -a "$audit_log"
            /usr/sbin/softwareupdate -i -a -R
        fi
    else
        echo "$(date -u) Settings for: sysprefs_softwareupdate_current already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_softwareupdate_current has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
/bin/launchctl disable system/com.openssh.sshd ' N
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_ssh_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/sbin/systemsetup -f -setremotelogin off >/dev/null
/bin/launchctl disable system/com.openssh.sshd
        fi
    else
        echo "$(date -u) Settings for: sysprefs_ssh_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_ssh_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
/usr/bin/security authorizationdb write system.preferences < /tmp/system.preferences.plist ' N
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_system_wide_preferences_configure ..." | /usr/bin/tee -a "$audit_log"
...
/usr/bin/security authorizationdb write system.preferences < /tmp/system.preferences.plist
        ...
        echo "$(date -u) Settings for: sysprefs_system_wide_preferences_configure already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_system_wide_preferences_configure has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
...
if [[ ! $exempt == "1" ]] || [[ -z $exempt ]];then
    if [[ $sysprefs_wake_network_access_disable_audit_score == "true" ]]; then
        ...
        if [[ $? == 0 ]]; then
            echo "$(date -u) Running the command to configure the settings for: sysprefs_wake_network_access_disable ..." | /usr/bin/tee -a "$audit_log"
            /usr/bin/pmset -a womp 0
        fi
    else
        echo "$(date -u) Settings for: sysprefs_wake_network_access_disable already configured, continuing..." | /usr/bin/tee -a "$audit_log"
    fi
elif [[ ! -z "$exempt_reason" ]];then
    echo "$(date -u) sysprefs_wake_network_access_disable has an exemption, remediation skipped (Reason: "$exempt_reason")" | /usr/bin/tee -a "$audit_log"
fi
